...
<div class="container"> 
    <div class="header">
        <a href="index.html" ><img src="images/bgnone.png" alt="logo" class="logo"></a>
         ...
         <div class="icon">
            <form action="">
                <a href="search.html" ><input type="search" placeholder="Search here ..."></a>
...
<!----------------------------------------------------------------------------------------------------------------->
                ...
                <div class="nav container">
                    ...
                    <div class="cart">
                        ...
                        <!-- BUY BUTTON  -->
                        <a href="action_page.html"><button type="button" class="btn-buy">Buy Now</button></a>
                        <!-- CART CLOSE  -->
    ...
    <section class="shop container">
      ...
      <div class="card">
        ...
        <button class="btn-more" onclick="window.location.href='registration_form.html'">Registration</button>
