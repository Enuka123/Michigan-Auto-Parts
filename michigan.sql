...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 19, 2025 at 06:21 PM
...
(1, 'Head Lamp', 'A headlamp is a lamp attached to the front of a vehicle to illuminate the road ahead. ', './uploads/p1.jpg', 13000, 3, '2023-05-24'),
(2, 'Tail Lamp', 'A tail lamp in a car is a crucial component of the vehicle\'s lighting system, typically located at the rear end. ', './uploads/p2.jpg', 10000, 3, '2024-02-28'),
(8, 'Frot Bumper', 'The front of a car is called the hood (American English) or bonnet (British English). ', './uploads/p3.jpg', 15000, 3, '2021-01-13'),
(9, 'Rear Bumper', 'Rear Bumper for Sale at Best Price ', './uploads/p4.jpeg', 12000, 2, '2025-02-19'),
(10, 'AC Compressor', 'The AC compressor is a crucial component of a heating, ventilation, and air conditioning (HVAC) system. ', './uploads/p12.jpg', 16000, 2, '2025-02-19'),
(11, 'Steering Wheel', 'Buy original gaming steering wheels from TecRoot for the best price in Sri Lanka.', './uploads/p6.jpeg', 11000, 3, '2025-02-19'),
(12, 'Engine Top Cover', 'ngine Cover for sale at best price in Sri Lanka.', './uploads/p7.jpeg', 14500, 3, '2025-02-19');
...
('enuka', 'gayashan', 'enukagayashan1234@gmail.com', 123);
...
INSERT INTO `users` (`user_id`, `first_name`, `last_name`, `email`, `password`, `contact_no`, `user_address`, `registered_at`, `isAdmin`) VALUES
(1, 'ireshika', 'sewwandi', 'admin1@gmail.com', 'admin', '0761132393', 'kandiyapita, kotaweheramankada', '2025-02-19', 0);
